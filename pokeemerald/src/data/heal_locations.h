static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_KNOWHERE - 1] = {MAP_GROUP(KNOWHERE), MAP_NUM(KNOWHERE), 500, 10},
    [HEAL_LOCATION_SPECTRE_VILLE - 1] = {MAP_GROUP(SPECTRE_VILLE), MAP_NUM(SPECTRE_VILLE), 13, 7},
    [HEAL_LOCATION_SOMEPLACE - 1] = {MAP_GROUP(SOMEPLACE), MAP_NUM(SOMEPLACE), 12, 13},
};
