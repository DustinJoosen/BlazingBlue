...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_BODILAD]     = { .size = 0x88, .y_offset = 0 },
	[SPECIES_TANDEMAUS]   = { .size = 0x88, .y_offset =  8 },
	[SPECIES_TOXEL]   = { .size = 0x88, .y_offset =  8 },
	[SPECIES_TOXTRICITY]   = { .size = 0x88, .y_offset =  8 },
	[SPECIES_PIPLUP]   = { .size = 0x88, .y_offset =  8 },
	[SPECIES_JOLTIK]   = { .size = 0x88, .y_offset =  8 },
	[SPECIES_GALVANTULA]   = { .size = 0x88, .y_offset =  8 },
	[SPECIES_BLIPBUG]   = { .size = 0x88, .y_offset =  8 },
	[SPECIES_DOTTLER]   = { .size = 0x88, .y_offset =  8 },
	[SPECIES_ORBEETLE]   = { .size = 0x88, .y_offset =  8 },
	[SPECIES_IMPIDIMP]   = { .size = 0x88, .y_offset =  8 },
	[SPECIES_MAREANIE]   = { .size = 0x88, .y_offset =  8 },
	[SPECIES_TOXAPEX]   = { .size = 0x88, .y_offset =  8 },
	...
	[SPECIES_FRILLISH]   = { .size = 0x88, .y_offset =  8 },
	[SPECIES_JELLICENT]   = { .size = 0x88, .y_offset =  8 },
	[SPECIES_GLACEON]   = { .size = 0x88, .y_offset =  8 },
	[SPECIES_LEAFEON]   = { .size = 0x88, .y_offset =  8 },
	[SPECIES_SYLVEON]   = { .size = 0x88, .y_offset =  8 },
	[SPECIES_SEWADDLE]   = { .size = 0x88, .y_offset =  8 },
	[SPECIES_SWADLOON]   = { .size = 0x88, .y_offset =  8 },
	[SPECIES_LEAVANNY]   = { .size = 0x88, .y_offset =  8 },
	[SPECIES_OVERQWIL]   = { .size = 0x88, .y_offset =  8 },
