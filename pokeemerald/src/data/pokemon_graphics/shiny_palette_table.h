const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(BODILAD, gMonShinyPalette_Bodilad),
	SPECIES_SHINY_PAL(TANDEMAUS, gMonPalette_Tandemaus),
	SPECIES_SHINY_PAL(TOXEL, gMonPalette_Toxel),
	SPECIES_SHINY_PAL(TOXTRICITY, gMonPalette_Toxtricity),
	SPECIES_SHINY_PAL(PIPLUP, gMonPalette_Piplup),
	SPECIES_SHINY_PAL(JOLTIK, gMonPalette_Joltik),
	SPECIES_SHINY_PAL(GALVANTULA, gMonPalette_Galvantula),
	SPECIES_SHINY_PAL(BLIPBUG, gMonPalette_Blipbug),
	SPECIES_SHINY_PAL(DOTTLER, gMonPalette_Dottler),
	SPECIES_SHINY_PAL(ORBEETLE, gMonPalette_Orbeetle),
	SPECIES_SHINY_PAL(IMPIDIMP, gMonPalette_Impidimp),
	SPECIES_SHINY_PAL(MAREANIE, gMonPalette_Mareanie),
	SPECIES_SHINY_PAL(TOXAPEX, gMonPalette_Toxapex),
	SPECIES_SHINY_PAL(LILLIPUP, gMonPalette_Lillipup),
	SPECIES_SHINY_PAL(HERDIER, gMonPalette_Herdier),
	SPECIES_SHINY_PAL(STOUTLAND, gMonPalette_Stoutland),
	SPECIES_SHINY_PAL(MORGREM, gMonPalette_Morgrem),
	SPECIES_SHINY_PAL(GRIMMSNARL, gMonPalette_Grimmsnarl),
	SPECIES_SHINY_PAL(FRILLISH, gMonPalette_Frillish),
	SPECIES_SHINY_PAL(JELLICENT, gMonPalette_Jellicent),
	SPECIES_SHINY_PAL(GLACEON, gMonPalette_Glaceon),
	SPECIES_SHINY_PAL(LEAFEON, gMonPalette_Leafeon),
	SPECIES_SHINY_PAL(SYLVEON, gMonPalette_Sylveon),
	SPECIES_SHINY_PAL(SEWADDLE, gMonPalette_Sewaddle),
	SPECIES_SHINY_PAL(SWADLOON, gMonPalette_Swadloon),
	SPECIES_SHINY_PAL(LEAVANNY, gMonPalette_Leavanny),
	SPECIES_SHINY_PAL(OVERQWIL, gMonPalette_Overqwil),
	SPECIES_SHINY_PAL(MAUSHOLD, gMonPalette_Maushold),
	SPECIES_SHINY_PAL(DRIPLETT, gMonPalette_Driplett),
