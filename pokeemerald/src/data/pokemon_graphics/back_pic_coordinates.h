...
const struct MonCoords gMonBackPicCoords[] =
{
	...
	[SPECIES_PIPLUP]   = { .size = 0x88, .y_offset =  10 },
    [SPECIES_JOLTIK]                       = { .size = MON_COORDS_SIZE(48, 32), .y_offset = 19 },
    [SPECIES_GALVANTULA]                   = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 18 },
	[SPECIES_BLIPBUG]   = { .size = 0x88, .y_offset =  10 },
	[SPECIES_DOTTLER]   = { .size = 0x88, .y_offset =  10 },
	[SPECIES_ORBEETLE]   = { .size = 0x88, .y_offset =  10 },
    [SPECIES_IMPIDIMP]    = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 13 },
	[SPECIES_MAREANIE]   = { .size = 0x88, .y_offset =  10 },
	[SPECIES_TOXAPEX]   = { .size = 0x88, .y_offset =  10 },
