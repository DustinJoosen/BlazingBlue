...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_BODILAD]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  0 },
	[SPECIES_TANDEMAUS]   = { .size = 0x88, .y_offset =  10 },
	...
	[SPECIES_MORGREM]   = { .size = 0x88, .y_offset =  10 },
	[SPECIES_GRIMMSNARL]   = { .size = 0x88, .y_offset =  10 },
	[SPECIES_FRILLISH]   = { .size = 0x88, .y_offset =  10 },
	[SPECIES_JELLICENT]   = { .size = 0x88, .y_offset =  10 },
	[SPECIES_GLACEON]   = { .size = 0x88, .y_offset =  10 },
	[SPECIES_LEAFEON]   = { .size = 0x88, .y_offset =  10 },
	[SPECIES_SYLVEON]   = { .size = 0x88, .y_offset =  10 },
	[SPECIES_SEWADDLE]   = { .size = 0x88, .y_offset =  10 },
	[SPECIES_SWADLOON]   = { .size = 0x88, .y_offset =  10 },
	[SPECIES_LEAVANNY]   = { .size = 0x88, .y_offset =  10 },
	[SPECIES_OVERQWIL]   = { .size = 0x88, .y_offset =  10 },
