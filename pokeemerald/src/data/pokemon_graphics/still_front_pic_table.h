...
// Gen III
    ...
    SPECIES_SPRITE(BODILAD,       gMonStillFrontPic_Bodilad),
	...
	SPECIES_SPRITE(BLIPBUG, gMonStillFrontPic_Blipbug),
	SPECIES_SPRITE(DOTTLER, gMonStillFrontPic_Dottler),
	SPECIES_SPRITE(ORBEETLE, gMonStillFrontPic_Orbeetle),
	SPECIES_SPRITE(IMPIDIMP, gMonStillFrontPic_Impidimp),
	SPECIES_SPRITE(MAREANIE, gMonStillFrontPic_Mareanie),
	...
	SPECIES_SPRITE(MORGREM, gMonStillFrontPic_Morgrem),
	SPECIES_SPRITE(GRIMMSNARL, gMonStillFrontPic_Grimmsnarl),
	SPECIES_SPRITE(FRILLISH, gMonStillFrontPic_Frillish),
	SPECIES_SPRITE(JELLICENT, gMonStillFrontPic_Jellicent),
	...
	SPECIES_SPRITE(DRIPLETT, gMonStillFrontPic_Driplett),
