...
} gTMHMLearnsets[NUM_SPECIES] =
{
	...
	[SPECIES_TOXEL] = { .learnset = {
		.REST = TRUE,
		.PROTECT = TRUE,
		.ATTRACT = TRUE,
		.FACADE = TRUE,
	}},
	[SPECIES_TOXTRICITY] = { .learnset = {
		.PROTECT = TRUE,
		.THIEF = TRUE,
		.FACADE = TRUE,
		.SUNNY_DAY = TRUE,
	...
	[SPECIES_BLIPBUG] = { .learnset = {
	}},
	[SPECIES_DOTTLER] = { .learnset = {
		.SOLAR_BEAM = TRUE,
		.LIGHT_SCREEN = TRUE,
		.REFLECT = TRUE,
		.SAFEGUARD = TRUE,
